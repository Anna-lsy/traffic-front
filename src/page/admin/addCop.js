...
class Admin extends PureComponent{
    ...
    handleAddCop = () => {
        ...
        this.props.addCop(id, password, name, phone ,local);
    };
                                    ...
                                    <div className="col-md-6 col-xl-4">
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">添加警察</h3>
                                            </div>
...
const mapDispatchToProps = (dispatch) => ({
    ...
    addCop(id, password, name, phone ,local){
        dispatch(actionCreators.addCop(id, password, name, phone ,local));
    }
});
